...
export default async function EventView() {
    ...
    //         setIsLoading(true);
    //         const event = await getEventByDateAndId(params.date as string, params.id as string)
    //         console.log(event)
    //         setIsLoading(false)
    //     };
    //     fetchEvent();
    ...
    return (
        <ThemeContext.Provider value={themeContextValue}>
            <SafeAreaView className={"flex-1"}>
                ...
                {/*    <View className={"flex-1 justify-center m-5 rounded-lg bg-white p-3 flex-col border-2"}*/}
                {/*          style={{borderColor: "#08238550"}}>*/}
